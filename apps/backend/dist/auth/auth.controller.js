...
let AuthController = class AuthController {
    ...
    async fixBaekAccount() {
        ...
        if (user) {
            await this.usersService.updateUserRole(user.id, user_entity_1.UserRole.ADMIN, 'system');
...
__decorate([
    (0, common_1.Post)('fix-baek'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "fixBaekAccount", null);
