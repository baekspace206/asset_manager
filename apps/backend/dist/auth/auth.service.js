...
let AuthService = class AuthService {
    ...
    async validateUser(username, password) {
        ...
        if (user.status === user_entity_1.UserStatus.PENDING) {
            throw new common_1.UnauthorizedException('Your account is pending approval. Please wait for admin approval.');
        }
        if (user.status === user_entity_1.UserStatus.REJECTED) {
            throw new common_1.UnauthorizedException('Your account has been rejected. Please contact the administrator.');
        }
    ...
    async getProfileWithPermissions(userId) {
